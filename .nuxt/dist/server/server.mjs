import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, inject as inject$1, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, watch, onScopeDispose, watchEffect, capitalize, Fragment, warn, ref, computed, provide, unref, defineComponent as defineComponent$1, toRefs, h, toValue, createVNode, mergeProps, createElementVNode, normalizeClass, defineAsyncComponent, Suspense, nextTick, withCtx, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "ofetch";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "G:/99.Github/toolutils/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "G:/99.Github/toolutils/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "G:/99.Github/toolutils/node_modules/h3/dist/index.mjs";
...
import { toRouteMatcher, createRouter } from "G:/99.Github/toolutils/node_modules/radix3/dist/index.mjs";
import { defu } from "G:/99.Github/toolutils/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, isScriptProtocol } from "G:/99.Github/toolutils/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    meta: { "middleware": "redirect-home" },
    component: () => import("./_nuxt/index-xCEks7Fx.js")
  },
  {
    name: "json-formatter",
    path: "/json-formatter",
    component: () => import("./_nuxt/index-qWGtSgUe.js")
  },
  {
    name: "text-formatter",
    path: "/text-formatter",
    component: () => import("./_nuxt/index-BuSDF2-P.js")
  },
  {
    name: "base64-formatter",
    path: "/base64-formatter",
    component: () => import("./_nuxt/index-DZz5X7I6.js")
  },
  {
    name: "getting-started-introduction",
    path: "/getting-started/introduction",
    component: () => import("./_nuxt/introduction-Bv7l6I3Q.js")
  }
];
...
const namedMiddleware = {
  "redirect-home": () => import("./_nuxt/redirect-home-CYtkrLbT.js")
};
...
const vuetify_hjFy4UiBVKu2U8_BW9ggkFzfvErKr3wFgTHpa6TF5Ds = /* @__PURE__ */ defineNuxtPlugin((app) => {
  const vuetify = createVuetify({
    ...
    defaults: {
      VBtn: {
        class: "text-white px-4 py-2 text-sm md:text-base lg:text-lg",
        // Tailwind responsive
        color: "#328E6E",
        rounded: "md",
        elevation: 1
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-BOkHkUmW.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CXub4Abh.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-iRJS09ml.js"));
...
export {
  destructComputed as A,
  isCssColor as B,
  isParsableColor as C,
  parseColor as D,
  EventProp as E,
  getForeground as F,
