import { computed, createElementVNode, normalizeStyle, normalizeClass, TransitionGroup, Transition, h, camelize, mergeProps, toRef, createVNode, withDirectives, vShow, useId, ref, watch, Fragment, inject, shallowRef, unref, nextTick, watchEffect, vModelText, defineComponent, isRef, withCtx, createTextVNode, toDisplayString, withModifiers, useSSRContext } from "vue";
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate } from "vue/server-renderer";
import { u as useTextColor, a as useRender, m as makeComponentProps, V as VIcon, b as makeRoundedProps, c as makeLoaderProps, d as useLoader, e as useRounded, f as useBackgroundColor, L as LoaderSlot, g as VDefaultsProvider, h as makeDensityProps, i as makeDimensionProps, j as useDensity, k as useDimension, l as VBtn } from "./VBtn-B-xsRwMi.js";
import { g as genericComponent, p as propsFactory, d as provideTheme, e as convertToUnit, m as makeThemeProps, i as isObject, E as EventProp, f as useLocale, h as callEvent, j as getCurrentInstanceName, k as useProxiedModel, I as IconValue, l as useRtl, w as wrapInArray, o as getCurrentInstance, q as useToggleScope, s as pick, v as clamp, x as filterInputAttrs, _ as _export_sfc } from "../server.mjs";
import "ofetch";
...
function trimMultiline(text, removeLines = false) {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const handleSentenceCase = () => {
      const text = textRoot.value.trim();
      textResult.value = text.split(/([.?!]\s*)/).map((part, i) => i % 2 === 0 ? _toSentenceCase(part.trim()) : part).join("");
    };
    const handleCopyText = async () => {
      if (textResult.value) {
        try {
          await (void 0).clipboard.writeText(textResult.value);
          isCopied.value = true;
    ...
    const insertTab = (event, modelName) => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "lg:col-span-12" }, _attrs))} data-v-c016defe><div class="relative border-b border-default py-8" data-v-c016defe><div class="" data-v-c016defe><div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4" data-v-c016defe><h1 class="text-3xl sm:text-4xl text-pretty font-bold text-highlighted" data-v-c016defe>Text Fomatter</h1></div><div class="text-lg text-pretty text-muted mt-4" data-v-c016defe>Hỗ trợ các thao tác với text.</div></div></div>`);
      _push(ssrRenderComponent(VDivider, null, null, _parent));
      _push(`<div class="mt-8 pb-24 space-y-12" data-v-c016defe><div id="#automation-and-conventions" class="section" data-v-c016defe>`);
      _push(ssrRenderComponent(VTextarea, {
        label: "Vui lòng nhập text...",
        variant: "outlined",
        rows: "10",
        modelValue: unref(textRoot),
        "onUpdate:modelValue": ($event) => isRef(textRoot) ? textRoot.value = $event : null,
        onKeydown: ($event) => insertTab($event)
      }, null, _parent));
      _push(`<div class="flex flex-col sm:flex-row gap-2 mt-4" data-v-c016defe>`);
      _push(ssrRenderComponent(VBtn, {
        flat: "",
        onClick: handleUperCaseText
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-ellipsis normal-case" data-v-c016defe${_scopeId}>UPER CASE</span>`);
          } else {
            return [
              createVNode("span", { class: "text-ellipsis normal-case" }, "UPER CASE")
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(VBtn, {
        flat: "",
        onClick: handleLowCaseText
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-ellipsis normal-case" data-v-c016defe${_scopeId}>lower case</span>`);
          } else {
            return [
              createVNode("span", { class: "text-ellipsis normal-case" }, "lower case")
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(VBtn, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-ellipsis normal-case" data-v-c016defe${_scopeId}>Sentence case</span>`);
          } else {
            return [
              createVNode("span", { class: "text-ellipsis normal-case" }, "Sentence case")
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(VBtn, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-ellipsis normal-case" data-v-c016defe${_scopeId}>Trim</span>`);
          } else {
            return [
              createVNode("span", { class: "text-ellipsis normal-case" }, "Trim")
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(VBtn, {
        flat: "",
        onClick: removeLineEmpty
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-ellipsis normal-case" data-v-c016defe${_scopeId}>Remove Line Empty</span>`);
          } else {
            return [
              createVNode("span", { class: "text-ellipsis normal-case" }, "Remove Line Empty")
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(VBtn, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-ellipsis normal-case" data-v-c016defe${_scopeId}>Clear</span>`);
          } else {
            return [
              createVNode("span", { class: "text-ellipsis normal-case" }, "Clear")
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</div></div><div id="#automation-and-conventions" class="section" data-v-c016defe><h1 class="text-xl font-bold text-pretty pb-2" data-v-c016defe>Text kết quả</h1>`);
      _push(ssrRenderComponent(VTextarea, {
        variant: "outlined",
        modelValue: unref(textResult),
        "onUpdate:modelValue": ($event) => isRef(textResult) ? textResult.value = $event : null,
        rows: "10",
        readonly: ""
      }, {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(VIcon, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(isCopied) ? "mdi-check-circle-outline" : "mdi-content-copy")}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(isCopied) ? "mdi-check-circle-outline" : "mdi-content-copy"), 1)
                  ];
                }
              }),
              _: 1
            ...
            return [
              createVNode(VIcon, {
                class: "cursor-pointer",
                tabindex: "-1",
                onMousedown: withModifiers(handleCopyText, ["prevent", "stop"]),
                title: "Copy"
              }, {
                default: withCtx(() => [
                  createTextVNode(toDisplayString(unref(isCopied) ? "mdi-check-circle-outline" : "mdi-content-copy"), 1)
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/text-formatter/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c016defe"]]);
export {
  index as default
};
//# sourceMappingURL=index-BuSDF2-P.js.map
